        ...
        <div className="mx-auto w-2/3 flex flex-col place-items-center md:place-items-stretch">
          ...
          <div className="flex flex-row justify-evenly w-full">
            ...
            >
              ...
              <span className="relative group-hover:text-white">Edit Profile</span>
            </Link>
            ...
            >
              <span className="absolute top-0 left-0 flex w-full h-0 mb-0 transition-all duration-200 ease-out transform translate-y-0 bg-gray-600 group-hover:h-full opacity-90"></span>
              <span className="relative group-hover:text-white">Add Product</span>
            </Link>
              ...
              <tbody className="text-left">
                {products.map((produk, index) => (
                  ...
                  >
                    ...
                    <td className="py-2 px-4">{produk.user_id.name}</td>
