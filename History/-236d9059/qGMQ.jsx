...
const GetMeCard = () => {
  ...
  return (
    ...
    <div className=" max-w-lg bg-white rounded-xl dark:bg-blue-800 shadow-lg transform duration-200 easy-in-out mt-12 py-1">
      ...
      <div>
        <div className="px-7 mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-300">
            ...
            fugit nesciunt. nesciunt. nesciunt. nesciunt. nesciunt. nesciunt.
          </p>
