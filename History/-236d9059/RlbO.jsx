...
const GetMeCard = () => {
  return (
    ...
    <div className=" max-w-lg bg-white rounded dark:bg-blue-800 shadow-lg transform duration-200 easy-in-out mt-12">
      ...
      <div className="flex justify-start px-5 mt-12 mb-5">
        <span className="block relative h-32 w-32">
          <img
            ...
            className="mx-auto object-cover rounded-full h-24 w-24 bg-white p-1 pt-2"
          />
        </span>
      </div>
      <div>
