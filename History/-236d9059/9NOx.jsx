...
const GetMeCard = () => {
  return (
    // <div class=" bg-gray-200 dark:bg-gray-900 flex flex-wrap items-center justify-center">
      <div class=" max-w-3xl bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out m-12">
        ...
        <div class="">
          <div class="px-7 mb-8">
            ...
            <div class="justify-center px-4 py-2 cursor-pointer bg-green-900 max-w-min mx-auto mt-8 rounded-lg text-gray-300 hover:bg-green-800 hover:text-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-gray-200">
