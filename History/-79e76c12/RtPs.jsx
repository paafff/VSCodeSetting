    ...
    <Layout>
      <>
        <div className=" flex justify-center items-center min-h-screen  ">
          <div className="bg-slate-500 h-full place-items-center flex flex-col md:flex-row justify-evenly w-full max-w-7xl p-4 bg-none  rounded-lg  sm:p-6 md:p-8">
            <div className="h-1/5 md:pt-0 pt-10 md:self-start  flex flex-col justify-center items-center">
              <div className="">
                <button onClick={onHideShowClick}>
                  <div class=" relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-gray-600 border-2 border-gray-600 hover:border-yellow-600 rounded-full hover:text-gray-100 group hover:bg-yellow-600">
