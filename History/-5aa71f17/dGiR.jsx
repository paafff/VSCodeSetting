              ...
              <div className=" w-20 flex justify-center items-center">
                ...
                >
                  <div className="flex justify-center items-center space-x-3 cursor-pointer">
                    <div className="w-10 h-10 rounded-full overflow-hidden border-1 dark:border-white border-gray-900">
                      <img
                  ...
                  {open && (
                    <div className="absolute w-60 px-5 py-3 dark:bg-gray-800 bg-white rounded-lg shadow border dark:border-transparent mt-5">
                      ...
                      <hr className="dark:border-gray-700 py-1" />
                      <ul className="space-y-3 py-2 dark:text-white">
