        ...
        <form onSubmit={articleCreate}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) => {
                setImgFilesOne(e.target.files ? e.target.files[0] : ppSaya);
              }}
              // required
            />
            <input
              ...
              accept="image/*"
              onChange={(e) => {
                setImgFilesTwo(e.target.files ? e.target.files[0] : ppSaya);
              }}
              // required
            />
            <input
              ...
              accept="image/*"
              onChange={(e) => {
                setImgFilesThree(e.target.files ? e.target.files[0] : ppSaya);
              }}
              // required
            />
          </div>
