...
import ppAku from '../assets/ppSaya.png';
...
const ArticleCreateForm = () => {
  ...
  const [imgFilesOne, setImgFilesOne] = useState(ppSaya);
  const [imgFilesTwo, setImgFilesTwo] = useState(ppSaya);
  const [imgFilesThree, setImgFilesThree] = useState(ppSaya);
