  ...
  const articleCreate = async (e) => {
    ...
    try {
      ...
      console.log('Data yang akan dikirim:', {
        ...
        name: userData.name,
        email: userData.email,
        imgFilesOne: imgFilesOne || ppAku,
        imgFilesTwo: imgFilesTwo || ppAku,
        imgFilesThree: imgFilesThree || ppAku,
      });
        ...
        <form onSubmit={articleCreate}>
          <div className="mb-4">
            ...
            <input
              ...
              value={title}
              onChange={(e) => setTitle(setSummary ? e.target.value : ppAku)}
              required
            />
          </div>
          <div className="mb-4">
            ...
            <textarea
              ...
              value={content}
              rows="40"
              onChange={(e) => setContent(setSummary ? e.target.value : ppAku)}
              required
            />
          </div>
          <div className="mb-4">
            ...
            <textarea
              ...
              value={summary}
              rows="10"
              onChange={(e) => (setSummary ? e.target.value : ppAku)}
              required
            />
          </div>
          {/* <div className="mb-4">
