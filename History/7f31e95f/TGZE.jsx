...
import ppSaya from '../assets/Foto.js';
  ...
  const articleCreate = async (e) => {
    ...
    try {
      ...
      if (imgFilesOne) {
        ...
        formArticleData.append('imgFilesOne', imgFiles);
      }

      if (imgFilesTwo) {
        formArticleData.append('imgFilesTwo', imgFilesTwo);
      } else {
        formArticleData.append('imgFilesTwo', imgFiles);
      }

      if (imgFilesThree) {
        formArticleData.append('imgFilesThree', imgFilesThree);
      } else {
        formArticleData.append('imgFilesThree', imgFiles);
      }
