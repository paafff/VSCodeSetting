        ...
        <form onSubmit={articleCreate}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) => {
                setImgFilesOne(e.target.files[0] ? e.target.files[0] : ppSaya);
              }}
              // required
            />
            <input
              ...
              accept="image/*"
              onChange={(e) => {
                setImgFilesTwo(e.target.files[0] ? e.target.files[0] : ppSaya);
              }}
              // required
            />
            <input
              ...
              onChange={(e) => {
                setImgFilesThree(
                  e.target.files[0] ? e.target.files[0] : ppSaya
                );
              }}
              // required
            />
