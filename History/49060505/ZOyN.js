...
app.use(
  session({
    ...
    resave: false,
    // sesi tidak akan disimpan ulang kecuali ada perubahan dalam sesi tersebut
    saveUninitialized: true,
    // untuk memastikan bahwa setiap pengunjung situs web memiliki sesi unik, krn sesi akan disimpan meski belum ada data
