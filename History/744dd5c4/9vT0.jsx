...
const ArticleByTitle = () => {
  ...
  return (
    <div className="flex flex-col items-center ">
      <div className="relative max-w-6xl w-full h-80 flex flex-row justify-center bg-blue-300">
        <button
          onClick={goPrev}
        ...
        <div className="w-3/5 max-h-80 place-self-center">
          <img
            src={articleData.images[currentIndex]}
            alt="Article Image"
            className="object-cover object-center max-h-80 "
          />
        </div>
        <button
          onClick={goNext}
