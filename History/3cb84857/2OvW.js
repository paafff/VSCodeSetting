...
export const loginUser = async (req, res) => {
  ...
  // menampilkan data pada user yang sudah login berupa response json, dan kenapa dipisah/manual tidak seperti pada getme
  // karena agar lebih spesifik data apa saja yang ingin ditampilkan
  res
    .status(200)
